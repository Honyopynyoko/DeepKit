 ...
 */
import { BSON_BINARY_SUBTYPE_BIGINT, BSON_BINARY_SUBTYPE_BYTE_ARRAY, BSON_BINARY_SUBTYPE_UUID, digitByteSize, TWO_PWR_32_DBL_N } from './utils';
import { buildStringDecoder, decodeUTF8 } from './strings';
import { nodeBufferToArrayBuffer, typedArrayNamesMap } from '@deepkit/type';
 ...
 */
export function decodeUTF8Parser(parser, size = parser.size - parser.offset) {
...
export function deserialize(buffer, offset = 0) {
