...
exports.http = exports.httpActionParameter = exports.httpAction = exports.HttpActionDecorator = exports.httpClass = exports.HttpDecorator = exports.HttpAction = exports.HttpActionParameter = void 0;
...
class HttpController {
    ...
    getUrl(action) {
        return core_1.urlJoin('/', this.baseUrl, action.path);
    }
    addAction(action) {
...
exports.HttpActionParameter = HttpActionParameter;
class HttpAction {
    constructor() {
        this.name = '';
        this.description = '';
...
exports.httpClass = type_1.createClassDecoratorContext(HttpDecorator);
class HttpActionDecorator {
    ...
    onDecorator(target, property) {
        ...
        exports.httpClass.setAction(this.t)(target);
    }
    name(name) {
        this.t.name = name;
    }
...
exports.HttpActionDecorator = HttpActionDecorator;
class HttpActionParameterDecorator {
    ...
    onDecorator(target, propertyName, parameterIndex) {
        ...
        if (parameterIndex === undefined)
            throw new Error('@http action parameter decorator can only be used on method arguments.');
        const schema = type_1.getClassSchema(target);
        ...
        exports.httpAction.setParameter(property.name, this.t)(target.prototype, propertyName);
    }
    /**
...
type_1.createPropertyDecoratorContext(HttpActionDecorator);
exports.httpAction = type_1.createPropertyDecoratorContext(HttpActionDecorator);
exports.httpActionParameter = type_1.createPropertyDecoratorContext(HttpActionParameterDecorator);
exports.http = type_1.mergeDecorator(exports.httpClass, exports.httpAction, exports.httpActionParameter);
