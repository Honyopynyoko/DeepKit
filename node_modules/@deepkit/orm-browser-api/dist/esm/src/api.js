...
import { deserializeSchemas, entity, serializedSchemaDefinition, t } from '@deepkit/type';
...
DatabaseInfo = __decorate([
    ...
    __param(0, t.name('name')),
    __param(1, t.name('adapter')),
    __param(2, t.array(serializedSchemaDefinition).name('serializedSchemas')),
...
__decorate([
    t.type(() => EntityPropertyArraySeed).optional,
    __metadata("design:type", Object)
], EntityPropertySeed.prototype, "array", void 0);
__decorate([
    t.type(() => EntityPropertyMapSeed).optional,
    __metadata("design:type", Object)
...
export { EntityPropertyArraySeed };
...
export { SeedDatabase };
export const BrowserControllerInterface = ControllerSymbol('orm-browser/controller', [DatabaseInfo]);
