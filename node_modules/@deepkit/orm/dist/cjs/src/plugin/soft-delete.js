...
exports.SoftDelete = exports.SoftDeleteQuery = exports.SoftDeleteSession = void 0;
...
class SoftDeleteSession {
    ...
    setDeletedBy(classType, deletedBy) {
        this.deletedBy.set(type_1.getClassSchema(classType), deletedBy);
        return this;
    }
    restore(item) {
...
exports.SoftDeleteSession = SoftDeleteSession;
class SoftDeleteQuery extends query_1.Query {
    constructor() {
        super(...arguments);
...
class SoftDelete {
    ...
    disableForSchema(classSchemaOrType) {
        const schema = type_1.getClassSchema(classSchemaOrType);
    ...
    enableForSchema(classSchemaOrType) {
        ...
        function queryFilter(event) {
            ...
            if (query_1.Query.is(event.query, SoftDeleteQuery) && event.query.includeSoftDeleted === true)
                return;
        ...
        const queryDelete = this.database.queryEvents.onDeletePre.subscribe(async (event) => {
            ...
            if (hasDeletedBy && query_1.Query.is(event.query, SoftDeleteQuery) && event.query.setDeletedBy !== undefined) {
