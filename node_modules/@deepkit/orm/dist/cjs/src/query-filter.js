...
exports.convertQueryFilter = exports.replaceQueryFilterParameter = exports.exportQueryFilterFieldNames = void 0;
const type_1 = require("@deepkit/type");
const core_1 = require("@deepkit/core");
function exportQueryFilterFieldNames(classSchema, filter) {
    const filterFields = {};
    convertQueryFilter(classSchema, filter, (c, p, v) => v, filterFields);
    return Object.keys(filterFields);
}
exports.exportQueryFilterFieldNames = exportQueryFilterFieldNames;
function replaceQueryFilterParameter(classSchema, filter, parameters) {
...
exports.replaceQueryFilterParameter = replaceQueryFilterParameter;
function convertProperty(schema, property, fieldValue, name, converter, fieldNamesMap = {}, customMapping = {}) {
    if (core_1.isPlainObject(fieldValue)) {
        ...
        for (const key in fieldValue) {
            ...
            if (key[0] !== '$') {
                ...
                if (customMapping[key]) {
                    ...
                    fieldNamesMap[name] = true;
                    if (property.isArray && !type_1.isArray(value)) {
        ...
        fieldNamesMap[name] = true;
        if (property.isArray && !type_1.isArray(fieldValue)) {
            //implicit array conversion
...
function convertQueryFilter(classType, filter, converter, fieldNamesMap = {}, customMapping = {}) {
    const result = {};
...
exports.convertQueryFilter = convertQueryFilter;
