...
export declare enum RpcTypes {
    ...
    ActionObservableSubjectUnsubscribe = 20,
    ResponseActionObservable = 21,
    ResponseActionBehaviorSubject = 22,
    ResponseActionObservableNext = 23,
    ResponseActionObservableComplete = 24,
    ResponseActionObservableError = 25,
    ActionCollectionUnsubscribe = 26,
    ActionCollectionModel = 27,
    ResponseActionCollection = 28,
    ResponseActionCollectionModel = 29,
    ResponseActionCollectionSort = 30,
    ResponseActionCollectionState = 31,
    ResponseActionCollectionChange = 32,
    ResponseActionCollectionSet = 33,
    ResponseActionCollectionAdd = 34,
    ResponseActionCollectionRemove = 35,
    ResponseActionCollectionUpdate = 36,
    ResponseEntity = 37,
    Entity = 38,
    EntityPatch = 39,
    EntityRemove = 40
