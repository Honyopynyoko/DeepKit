...
export declare class RpcKernelConnection extends RpcKernelBaseConnection {
    ...
    routeType: RpcMessageRouteType.client | RpcMessageRouteType.server;
    constructor(writer: RpcConnectionWriter, connections: RpcKernelConnections, controllers: Map<string, ClassType>, security: RpcKernelSecurity, injector: BasicInjector, peerExchange: RpcPeerExchange, logger?: LoggerInterface);
...
export declare type OnConnectionCallback = (connection: RpcKernelConnection, injector: BasicInjector, logger: LoggerInterface) => void;
/**
...
export declare class RpcKernel {
    protected security: RpcKernelSecurity;
    protected logger: LoggerInterface;
    protected controllers: Map<string, ClassType<any>>;
    protected peerExchange: RpcPeerExchange;
    protected connections: RpcKernelConnections;
    protected injector: BasicInjector | InjectorContext;
    protected onConnectionListeners: OnConnectionCallback[];
    constructor(injector?: BasicInjector, security?: RpcKernelSecurity, logger?: LoggerInterface);
     ...
     */
    registerController(id: string | ControllerDefinition<any>, controller: ClassType, addAsProvider?: boolean): void;
