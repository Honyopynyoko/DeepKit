...
exports.ClientProgress = exports.RpcMessageWriter = exports.Progress = exports.SingleProgress = void 0;
const rxjs_1 = require("rxjs");
const model_1 = require("./model");
const protocol_1 = require("./protocol");
class SingleProgress extends rxjs_1.BehaviorSubject {
    constructor() {
        super(0);
        this.done = false;
        this.total = 0;
...
class RpcMessageWriter {
    constructor(writer, reader) {
         ...
         * In bytes.
         */
        this.cacheOnFileSystemWhenSizeIsAtLeast = 1000000;
        /**
         * When back-pressure is bigger than this value, we wait with sending new data.
         * In bytes.
         */
        this.stepBackWhenBackPressureBiggerThan = 500000;
        /**
         * Chunk size.
         * In bytes.
         */
