...
exports.DefaultPlatform = exports.SqlPlaceholderStrategy = exports.DefaultNamingStrategy = exports.isSet = void 0;
const table_1 = require("../schema/table");
const type_1 = require("@deepkit/type");
const sqlstring_1 = __importDefault(require("sqlstring"));
const core_1 = require("@deepkit/core");
const sql_serializer_1 = require("../serializer/sql-serializer");
const sql_filter_builder_1 = require("../sql-filter-builder");
function isSet(v) {
...
exports.SqlPlaceholderStrategy = SqlPlaceholderStrategy;
class DefaultPlatform {
    constructor() {
        this.defaultSqlType = 'text';
        this.typeMapping = new Map();
        this.nativeTypeInformation = new Map();
        this.serializer = sql_serializer_1.sqlSerializer;
    ...
    createSqlFilterBuilder(schema, tableName) {
        return new sql_filter_builder_1.SQLFilterBuilder(schema, tableName, this.serializer, new this.placeholderStrategy, this.quoteValue.bind(this), this.quoteIdentifier.bind(this));
    }
    getMigrationTableName() {
        return `deepkit_orm_migration`;
    }
    quoteValue(value) {
        if (!(value instanceof Date) && (core_1.isObject(value) || type_1.isArray(value)))
            return sqlstring_1.default.escape(JSON.stringify(value));
    ...
    addBinaryType(sqlType, size, scale) {
        for (const type of type_1.binaryTypes) {
    ...
    createTables(schemas, database = new table_1.DatabaseModel()) {
        ...
        for (let schema of schemas) {
            ...
            const table = new table_1.Table(this.namingStrategy.getTableName(schema));
    ...
    getIdentifier(object, append = '') {
        if (object instanceof table_1.Table)
    ...
    getColumnDefaultValueDDL(column) {
        ...
        return 'DEFAULT ' + this.quoteValue(core_1.isObject(column.defaultValue) ? JSON.stringify(column.defaultValue) : column.defaultValue);
    }
    getAutoIncrement() {
        return 'IDENTITY';
    }
