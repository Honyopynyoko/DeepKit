 ...
 */
import { empty, Mutex } from '@deepkit/core';
import { SqlBuilder, SQLConnection, SQLConnectionPool, SQLDatabaseAdapter, SQLDatabaseQuery, SQLDatabaseQueryFactory, SQLPersistence, SQLQueryResolver, SQLStatement } from '@deepkit/sql';
import { getClassSchema, getPropertyXtoClassFunction, resolvePropertySchema } from '@deepkit/type';
...
export class SQLiteQueryResolver extends SQLQueryResolver {
...
export class SQLiteDatabaseQuery extends SQLDatabaseQuery {
}
export class SQLiteDatabaseQueryFactory extends SQLDatabaseQueryFactory {
    ...
    createQuery(classType) {
        return new SQLiteDatabaseQuery(getClassSchema(classType), this.databaseSession, new SQLiteQueryResolver(this.connectionPool, this.platform, getClassSchema(classType), this.databaseSession));
    }
}
