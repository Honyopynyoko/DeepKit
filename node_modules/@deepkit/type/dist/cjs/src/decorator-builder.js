...
exports.isDecoratorContext = exports.createFreeDecoratorContext = exports.createPropertyDecoratorContext = exports.createClassDecoratorContext = exports.mergeDecorator = exports.createFluidDecorator = void 0;
function createFluidDecorator(api, modifier, collapse, returnCollapse = false, fluidFunctionSymbol) {
...
exports.createFluidDecorator = createFluidDecorator;
function mergeDecorator(...args) {
    const res = {};
...
function createClassDecoratorContext(apiType) {
    const map = new Map();
...
exports.createClassDecoratorContext = createClassDecoratorContext;
function createPropertyDecoratorContext(apiType) {
...
exports.createPropertyDecoratorContext = createPropertyDecoratorContext;
function createFreeDecoratorContext(apiType) {
...
exports.createFreeDecoratorContext = createFreeDecoratorContext;
function isDecoratorContext(context, fn) {
    const symbol = context._fluidFunctionSymbol;
    if (Object.getOwnPropertyDescriptor(fn, symbol))
        return true;
    return false;
}
exports.isDecoratorContext = isDecoratorContext;
