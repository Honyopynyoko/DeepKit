 ...
 */
export declare type ValidatorFn = (value: any, property: PropertySchema, classType?: ClassType) => void;
...
export interface FieldDecoratorResultBase<T> {
    ...
    }): FieldDecoratorResult<Reference<T>>;
    /**
    ...
    */
     ...
     * ```
     */
    validator(...validators: (ClassType<PropertyValidator> | ValidatorFn)[]): this;
    /**
...
export declare function isFieldDecorator(t: any): t is FieldDecoratorResult<any>;
