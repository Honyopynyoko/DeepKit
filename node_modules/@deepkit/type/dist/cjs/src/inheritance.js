...
exports.findCommonLiteral = exports.findCommonDiscriminant = void 0;
function findCommonDiscriminant(classSchemas) {
...
exports.findCommonDiscriminant = findCommonDiscriminant;
function findCommonLiteral(classSchemas) {
    const candidates = {};
    for (const schema of classSchemas) {
...
exports.findCommonLiteral = findCommonLiteral;
