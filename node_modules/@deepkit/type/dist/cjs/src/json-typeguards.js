...
exports.registerJSONTypeGuard = exports.jsonTypeGuards = void 0;
const core_1 = require("@deepkit/core");
const types_1 = require("./types");
exports.jsonTypeGuards = new Map();
function registerJSONTypeGuard(type, factory) {
    exports.jsonTypeGuards.set(type, factory);
}
exports.registerJSONTypeGuard = registerJSONTypeGuard;
...
registerJSONTypeGuard('enum', (property) => {
    return (v) => {
        return undefined !== v && !core_1.isValidEnumValue(property.resolveClassType, v, property.allowLabelsAsValue);
    };
});
...
for (const name of types_1.typedArrayNamesMap.keys()) {
