...
exports.getDataConverterJS = exports.executeCompiler = exports.reserveVariable = exports.CompilerState = void 0;
class CompilerState {
    constructor(originalSetter, originalAccessor, rootContext, jitStack, serializerCompilers) {
        this.originalSetter = originalSetter;
        this.originalAccessor = originalAccessor;
        this.rootContext = rootContext;
        this.jitStack = jitStack;
        this.serializerCompilers = serializerCompilers;
        this.template = '';
        this.ended = false;
        this.setter = '';
        this.accessor = '';
...
function reserveVariable(rootContext, name = 'var', value) {
...
exports.reserveVariable = reserveVariable;
function executeCompiler(rootContext, jitStack, compiler, setter, getter, property, serializerCompilers) {
    const state = new CompilerState(setter, getter, rootContext, jitStack, serializerCompilers);
    compiler(property, state);
    return state.template;
}
exports.executeCompiler = executeCompiler;
function getDataConverterJS(setter, accessor, property, serializerCompilers, rootContext, jitStack, undefinedSetterCode = '', nullSetterCode = '') {
...
exports.getDataConverterJS = getDataConverterJS;
//# sourceMappingURL=serializer-compiler.js.map