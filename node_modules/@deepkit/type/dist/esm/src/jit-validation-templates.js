...
registerCheckerCompiler('number', (accessor, property, utils) => {
    return `
...
registerCheckerCompiler('string', (accessor, property, utils) => {
    return `if ('string' !== typeof ${accessor}) ${utils.raise('invalid_string', 'No string given')};`;
});
registerCheckerCompiler('enum', (accessor, property, utils) => {
...
registerCheckerCompiler('boolean', (accessor, property, utils) => {
    return `
...
registerCheckerCompiler('uuid', (accessor, property, utils) => {
    return {
        template: `
...
registerCheckerCompiler('objectId', (accessor, property, utils) => {
    return {
        template: `
...
registerCheckerCompiler('date', (accessor, property, utils) => {
    return `
...
registerCheckerCompiler('class', (accessor, property, utils, jitStack) => {
...
registerCheckerCompiler('literal', (accessor, property, utils) => {
    //todo. really necessary? Because we force set the literal value always, no matter what value comes in.
    return '';
});
registerCheckerCompiler('union', (accessor, property, utils, jitStack) => {
