...
export function reserveVariable(rootContext, name = 'var', value) {
...
export function executeCompiler(rootContext, jitStack, compiler, setter, getter, property, serializerCompilers) {
    const state = new CompilerState(setter, getter, rootContext, jitStack, serializerCompilers);
    compiler(property, state);
    return state.template;
}
export function getDataConverterJS(setter, accessor, property, serializerCompilers, rootContext, jitStack, undefinedSetterCode = '', nullSetterCode = '') {
